...
class Preprocess:
    def process_dataset(self, dataset, pickle_name):
        ...
        matrix = np.vstack((sim_vector, question_vector, sum_val_vector, spacy_sim_vector))
    ...
    def process_run(self, query_candidates):
        ...
        feature_matrix = np.vstack((sim_vector, question_vector, sum_val_vector, spacy_sim_vector))
